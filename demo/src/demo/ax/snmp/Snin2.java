...
public class Snin2 {
	...
	public void initComm() throws IOException {
       ...
       public void setPDU() throws IOException {
              // set PDU
              PDU pdu = new PDU();
              pdu.add(new VariableBinding(new OID(".1.3.6.1.2.1.1.5.0"), new OctetString("os d hale")));
              pdu.setType(PDU.SET);
              sendPDU(pdu);
       }
       ...
       public void getPDU() throws IOException {
              // get PDU
              PDU pdu = new PDU();
              pdu.add(new VariableBinding(new OID("1.3.6.1.2.1.47.1.1.1.1.2")));
              pdu.setType(PDU.GET);
